...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="United Kingdom", blank_label=_("Select country"))
    city = models.CharField(verbose_name=_("City"), max_length=180, default="London")
    postal_code=models.CharField(verbose_name="Postal Code", max_length=100, default="140")
...
def final_property(self):
    ...
    price_after_tax = float(round(property_price * property_price, 2))
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    class Meta:
        verbose_name = _("Total Views Property")
        verbose_name_plural = _("Total Views Properties")